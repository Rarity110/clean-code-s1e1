...
var taskInput=document.querySelector('.item__input_new');//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    listItem.className="item list_item";
    ...
    deleteButton.className ="item__btn item__btn_delete btn";
